...
const { today: highTodays, tomorrow: highTomorrow } = HIGH_TEMPERATURE;
...
const makeServerRequess = new Promise((resolve, reject) => {
...
makeServerRequess.then(result => {
  console.log(result);
});

makeServerRequess.catch(error => {
  console.log(error);
})
